...
async function getSonFirsatUrunleri(limit = 20): Promise<Product[]> {
  try {
    // Fırsat ürünleri kategorisini bul
    ...
    // Tüm ürünleri çek, kategoriye ve son fırsat olmasına göre filtrele
    ...
    const parsedProducts = (allProductsData.products || [])
      .filter((product: Product) =>
        ...
        (
          ...
          product.variants?.some(v => v.metadata?.isLastChance === "True")
        )
      )
      .map((product: Product) => {
...
const Page = async () => {
  const products = await getSonFirsatUrunleri();
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="flex items-center justify-center space-x-2 mb-4">
              ...
              <h1 className="text-4xl font-bold">Son Fırsat Ürünleri</h1>
              <Flame className="h-8 w-8 animate-pulse" />
            </div>
            <p className="text-xl opacity-90 mb-6">
              Kaçırılmayacak son fırsatlar! Stoklar tükenmeden hemen al.
            </p>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        {/* Ürün Sayısı */}
        <div className="mb-6">
          <p className="text-gray-700 font-medium">{products.length} son fırsat ürünü bulundu</p>
        </div>
        ...
        {products.length === 0 && (
          <div className="text-center py-12">
            <p className="text-gray-500 text-lg">Henüz son fırsat ürünü bulunmuyor.</p>
          </div>
        )}
      </div>
    </div>
