...
async function getIndirimliUrunler(limit = 20): Promise<Product[]> {
  try {
    ...
    // Tüm ürünleri çek, kategoriye göre filtrele
    ...
    const parsedProducts = (allProductsData.products || [])
      ...
      .filter((product: Product) => {
        // En az bir varyantında birden fazla fiyat varsa ve eski fiyat yeni fiyattan büyükse indirimli kabul et
...
const Page = async () => {
  const products = await getIndirimliUrunler();
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl opacity-90 mb-6">
              İndirimde olan kadın giyim ürünleri burada!
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        {/* Ürün Sayısı */}
        <div className="mb-6">
          <p className="text-gray-700 font-medium">{products.length} indirimli ürün bulundu</p>
        </div>
        ...
        {products.length === 0 && (
          <div className="text-center py-12">
            <p className="text-gray-500 text-lg">Henüz indirimli ürün bulunmuyor.</p>
          </div>
        )}
      </div>
    </div>
